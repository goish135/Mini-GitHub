        ...
        for ( i = 0; i < MAX_CONNECTIONS; ++ i ) {
			    ...
			    if(strcmp(arg1,"Create")==0)
			    {
				    ...
				    else
				    {
					    ...
					    printf("Not Ok.\n");
                    				    ...
                    				    // receive file and save // print what server receive //
		    ...
		    else
		    {
			    ...
			    printf("Error argc.\n");
                    ...
                    if(ack==1) // Ok
	            {
			strcpy(inputBuffer,"Ok.");
		    }
                    else
		    {
		        strcpy(inputBuffer,"Reject.");   	    
		    }		
                    int eroor_occur = 0;
                    ...
                    if(eroor_occur==0)
                    {
                        ...
                        FILE *fp;
                        int ch = 0;
                        fp = fopen("./server_side/glad_receive.txt","a"); // save receive file's context 
                        int words;
